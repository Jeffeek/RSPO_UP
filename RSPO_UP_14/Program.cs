...
namespace RSPO_UP_14
{
	 ...
	 * 1. Даны названия 26 городов и стран, в которых они находятся. Среди них есть
		...
		б) в виде текста. (реализовать через 2 индексатора по индыксу и оп названию события)
		...
		IEnumirable ходит по элементам чей индекс кратен 3м.
	 * Для классов из задание 1 написать фабрику, которая принимает в метод создания
		...
		CreateInstanse&lt;T&gt; where T : Ваш супер класс.(1б)
